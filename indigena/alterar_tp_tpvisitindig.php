<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("SELECT * FROM TAB_APOIO_TPVISITINDIG WHERE ID = '$id';", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Atividade do Projeto - v.1.0.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_tpvisitindig.php?id=<?php echo $id; ?>" method="post" name="recebe_alterar_tp_tpvisitindig" enctype="multipart/form-data" id="recebe_alterar_tp_tpvisitindig">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="ATIVO" id="ATIVO" class="form-control">
                                <option value="1" <?php if (strcasecmp($vetor['ATIVO'],'1') == 0) : ?>selected="selected"<?php endif; ?>>ATIVO</option>
                                <option value="2" <?php if (strcasecmp($vetor['ATIVO'],'2') == 0) : ?>selected="selected"<?php endif; ?>>INATIVO</option>
                            </select>
                        </div>
                    </div>
                    </br>
