<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$SIGLA = $_POST['SIGLA'];
			$sql = mysql_query("UPDATE TAB_APOIO_UNIDMED_TEMPO SET DESCRICAO = '$DESCRICAO', SIGLA = '$SIGLA' WHERE ID = '$id';", $db) or die(mysql_error());
		/*
		...
		*/				
			echo"<script language=\"JavaScript\">
				location.href=\"listar_tp_unidmed_tempo.php\";
				</script>";
		}
	}
?>
