<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("DELETE FROM TAB_INDIG_NUCLEOS_LOCALIZACAO WHERE INDIG_NUCLOC_ID = '$LOCALIZACAO_ID' AND INDIG_NUCLOC_NUCLEO = '$NUCLEO_ID';", $db) or die(mysql_error());
		/*
