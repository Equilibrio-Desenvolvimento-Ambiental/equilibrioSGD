<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$ATIVO = $_POST['ATIVO'];
			$sql = mysql_query("UPDATE TAB_APOIO_TPVISITINDIG SET DESCRICAO = '$DESCRICAO', ATIVO = '$ATIVO' WHERE ID = '$id';", $db) or die(mysql_error());
		/*
		...
		*/				
			echo"<script language=\"JavaScript\">
				location.href=\"listar_tp_tpvisitindig.php\";
				</script>";
		}
	}
?>
