	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">							
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Tipos de Unidades de Medida - Tamanho/Dimensões - v.1.0.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_unidmed_tamanho.php" method="post" name="recebe_cadastrar_tp_unidmed_tamanho" enctype="multipart/form-data" id="recebe_cadastrar_tp_unidmed_tamanho">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="SIGLA" class="form-control" id="SIGLA" placeholder="Digite a sigla...">
                        </div>
                    </div>
                    </br>
