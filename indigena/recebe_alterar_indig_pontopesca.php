<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("UPDATE TAB_INDIG_PONTOPESCA SET INDIG_PP_NOME = '$INDIG_PP_NOME', INDIG_PP_NOME = '$INDIG_PP_NOME', INDIG_PP_COORD_FUSO = '$INDIG_PP_COORD_FUSO', INDIG_PP_COORD_ESTE = '$INDIG_PP_COORD_ESTE', INDIG_PP_COORD_NORTE = '$INDIG_PP_COORD_NORTE', INDIG_PP_COORD_ALT = '$INDIG_PP_COORD_ALT' WHERE INDIG_PP_ID = '$INDIG_PP_ID';", $db) or die(mysql_error());
		/*
