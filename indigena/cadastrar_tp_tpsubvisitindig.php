	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_tpsubvisitindig.php" method="post" name="tp_tpsubvisitindig" enctype="multipart/form-data" id="formID">
					...
					<div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea rows='5' class='form-control' name='TEXTO_PADRAO' id="TEXTO_PADRAO"></textarea>
                        </div>
                    </div>
                    </br>
