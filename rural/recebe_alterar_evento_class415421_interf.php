<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$CLASS415421_TIPO = $_POST['subtipo415421_interf'];
			$CLASS415421_DESCRICAO = $_POST['CLASS415421_DESCRICAO'];
			$sql = mysql_query("UPDATE TAB_415421_CLASSIFICACAO SET CLASS415421_TIPO = '$CLASS415421_TIPO', CLASS415421_DESCRICAO = '$CLASS415421_DESCRICAO' WHERE CLASS415421_CODIGO = '$id' AND EVENTOS_CODIGO = '$id_evento';", $db) or die(mysql_error());
