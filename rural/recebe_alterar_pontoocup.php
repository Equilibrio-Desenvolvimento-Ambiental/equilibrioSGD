<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			if(strcasecmp($nome_original,"") == 0){
				$sql = mysql_query("update TAB_RIR_PONTOOCUP set POCUP_PROCESSO = '$POCUP_PROCESSO', POCUP_AREAUSO =  '$POCUP_AREAUSO', POCUP_AREACACAU = '$POCUP_AREACACAU', POCUP_AREAFLO_PRI = '$POCUP_AREAFLO_PRI', POCUP_AREAFLO_SEC = '$POCUP_AREAFLO_SEC', POCUP_AREAPASTAGEM = '$POCUP_AREAPASTAGEM', POCUP_AREAOUTRAS =  '$POCUP_AREAOUTRAS', POCUP_AREAOUTRAS_TXT = '$POCUP_AREAOUTRAS_TXT', POCUP_MUNICIPIO = '$POCUP_MUNICIPIO', POCUP_SETOR = '$POCUP_SETOR', POCUP_ACESSO_UTME = '$POCUP_ACESSO_UTME', POCUP_ACESSO_UTMN = '$POCUP_ACESSO_UTMN', POCUP_ACESSO_DESC = '$POCUP_ACESSO_DESC', POCUP_PONTO_DATUM = '$POCUP_PONTO_DATUM', POCUP_PONTO_HEMISFERIO =  '$POCUP_PONTO_HEMISFERIO', POCUP_PONTO_FUSO = '$POCUP_PONTO_FUSO', POCUP_PONTO_UTME = '$POCUP_PONTO_UTME', POCUP_PONTO_UTMN = '$POCUP_PONTO_UTMN', POCUP_CONF_NORTE = '$POCUP_CONF_NORTE', POCUP_CONF_SIL = '$POCUP_CONF_SIL', POCUP_CONF_LESTE = '$POCUP_CONF_LESTE', POCUP_CONF_OESTE = '$POCUP_CONF_OESTE', POCUP_PLANEJAMENTO = '$POCUP_PLANEJAMENTO' where POCUP_CODIGO = '$id_ponto';", $db) or die(mysql_error());
			} else {
				...
				$sql = mysql_query("update TAB_RIR_PONTOOCUP set POCUP_PROCESSO = '$POCUP_PROCESSO', POCUP_AREAUSO =  '$POCUP_AREAUSO', POCUP_AREACACAU = '$POCUP_AREACACAU', POCUP_AREAFLO_PRI = '$POCUP_AREAFLO_PRI', POCUP_AREAFLO_SEC = '$POCUP_AREAFLO_SEC', POCUP_AREAPASTAGEM = '$POCUP_AREAPASTAGEM', POCUP_AREAOUTRAS =  '$POCUP_AREAOUTRAS', POCUP_AREAOUTRAS_TXT = '$POCUP_AREAOUTRAS_TXT', POCUP_MUNICIPIO = '$POCUP_MUNICIPIO', POCUP_SETOR = '$POCUP_SETOR', POCUP_ACESSO_UTME = '$POCUP_ACESSO_UTME', POCUP_ACESSO_UTMN = '$POCUP_ACESSO_UTMN', POCUP_ACESSO_DESC = '$POCUP_ACESSO_DESC', POCUP_PONTO_DATUM = '$POCUP_PONTO_DATUM', POCUP_PONTO_HEMISFERIO =  '$POCUP_PONTO_HEMISFERIO', POCUP_PONTO_FUSO = '$POCUP_PONTO_FUSO', POCUP_PONTO_UTME = '$POCUP_PONTO_UTME', POCUP_PONTO_UTMN = '$POCUP_PONTO_UTMN', POCUP_CONF_NORTE = '$POCUP_CONF_NORTE', POCUP_CONF_SIL = '$POCUP_CONF_SIL', POCUP_CONF_LESTE = '$POCUP_CONF_LESTE', POCUP_CONF_OESTE = '$POCUP_CONF_OESTE', POCUP_MAPA = '$POCUP_MAPA', POCUP_PLANEJAMENTO = '$POCUP_PLANEJAMENTO' where POCUP_CODIGO = '$id_ponto';", $db) or die(mysql_error());
			}
