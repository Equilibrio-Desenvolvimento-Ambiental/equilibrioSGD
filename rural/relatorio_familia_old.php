<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("select TAB_415421_EVENTOS.EVENTOS_CODIGO, TAB_415421_EVENTOS.EVENTOS_DATA, TAB_APOIO_EVENTOS.DESCRICAO as EVENTOS_TIPO_DESC, TAB_415421_EVENTOS.EVENTOS_OBSERVACOES, TAB_415421_FAMILIAS.FAMILIA_NUMERO, TAB_APOIO_BENEFICIOS.DESCRICAO as FAMILIA_BENEFICIO_DESC, TAB_415421_FAMILIAS.FAMILIA_BENEFICIARIO, TAB_415421_FAMILIAS.FAMILIA_LOCALDESTINO, TAB_APOIO_MUNICIPIOS.DESCRICAO as FAMILIA_MUNICIPIODESTINO_DESC, TAB_APOIO_SETORATEND.DESCRICAO as FAMILIA_SETORATEND_DESC, TAB_415421_DADOSGERAIS.DADOS_LOTERRC from TAB_415421_EVENTOS left outer join TAB_APOIO_EVENTOS ON TAB_415421_EVENTOS.EVENTOS_TIPO = TAB_APOIO_EVENTOS.ID left outer join TAB_415421_FAMILIAS ON TAB_415421_EVENTOS.FAMILIA_CODIGO = TAB_415421_FAMILIAS.FAMILIA_CODIGO left outer join TAB_APOIO_BENEFICIOS ON TAB_415421_FAMILIAS.FAMILIA_BENEFICIO = TAB_APOIO_BENEFICIOS.ID left outer join TAB_APOIO_MUNICIPIOS ON TAB_415421_FAMILIAS.FAMILIA_MUNICIPIODESTINO = TAB_APOIO_MUNICIPIOS.ID left outer join TAB_APOIO_SETORATEND ON TAB_415421_FAMILIAS.FAMILIA_SETORATEND = TAB_APOIO_SETORATEND.ID left outer join TAB_415421_DADOSGERAIS ON TAB_415421_DADOSGERAIS.FAMILIA_CODIGO = TAB_415421_FAMILIAS.FAMILIA_CODIGO where TAB_415421_EVENTOS.FAMILIA_CODIGO = '$id_familia';", $db);
			$vetor = mysql_fetch_array($sql);
			$sql_VISITAS415 = mysql_query("SELECT TAB_415_CLASSIFICACAO.EVENTOS_CODIGO, TAB_415_CLASSIFICACAO.CLASS415_CODIGO, TAB_APOIO_TPVISIT415.DESCRICAO AS PRI_ATIV, TAB_APOIO_TPSUBVISIT415.DESCRICAO AS SUB_ATIV, TAB_415_CLASSIFICACAO.CLASS415_DESCRICAO, TAB_415421_EVENTOS.EVENTOS_DATA FROM TAB_415421_EVENTOS LEFT OUTER JOIN TAB_415_CLASSIFICACAO ON  TAB_415_CLASSIFICACAO.EVENTOS_CODIGO = TAB_415421_EVENTOS.EVENTOS_CODIGO LEFT OUTER JOIN TAB_APOIO_TPSUBVISIT415 ON TAB_415_CLASSIFICACAO.CLASS415_TIPO = TAB_APOIO_TPSUBVISIT415.ID LEFT OUTER JOIN TAB_APOIO_TPVISIT415 ON TAB_APOIO_TPVISIT415.ID = TAB_APOIO_TPSUBVISIT415.ID_PRINCIPAL WHERE TAB_415_CLASSIFICACAO.CLASS415_CODIGO IS NOT NULL AND TAB_415421_EVENTOS.FAMILIA_CODIGO = '$id_familia' AND (TAB_415_CLASSIFICACAO.CLASS415_DESCRICAO IS NOT NULL OR TAB_415_CLASSIFICACAO.CLASS415_DESCRICAO <> '') ORDER BY TAB_415421_EVENTOS.EVENTOS_DATA DESC, TAB_415421_EVENTOS.EVENTOS_CODIGO ASC, PRI_ATIV ASC, SUB_ATIV ASC;", $db);
			$sql_VISITAS421 = mysql_query("select TAB_421_CLASSIFICACAO.EVENTOS_CODIGO, TAB_421_CLASSIFICACAO.CLASS421_CODIGO, TAB_APOIO_TPVISIT421.DESCRICAO AS PRI_ATIV, TAB_APOIO_TPSUBVISIT421.DESCRICAO AS SUB_ATIV, TAB_421_CLASSIFICACAO.CLASS421_DESCRICAO, TAB_415421_EVENTOS.EVENTOS_DATA from TAB_415421_EVENTOS left outer join TAB_421_CLASSIFICACAO on TAB_421_CLASSIFICACAO.EVENTOS_CODIGO = TAB_415421_EVENTOS.EVENTOS_CODIGO left outer join TAB_APOIO_TPSUBVISIT421 on TAB_421_CLASSIFICACAO.CLASS421_TIPO = TAB_APOIO_TPSUBVISIT421.ID left outer join TAB_APOIO_TPVISIT421 on TAB_APOIO_TPVISIT421.ID = TAB_APOIO_TPSUBVISIT421.ID_PRINCIPAL where TAB_421_CLASSIFICACAO.CLASS421_CODIGO is not null and TAB_415421_EVENTOS.FAMILIA_CODIGO = '$id_familia' AND (TAB_421_CLASSIFICACAO.CLASS421_DESCRICAO IS NOT NULL OR TAB_421_CLASSIFICACAO.CLASS421_DESCRICAO <> '') order by TAB_415421_EVENTOS.EVENTOS_DATA DESC, TAB_415421_EVENTOS.EVENTOS_CODIGO asc, PRI_ATIV asc, SUB_ATIV asc;", $db);
			$sql_VISITASRIR = mysql_query("select TAB_RIR_CLASSIFICACAO.EVENTOS_CODIGO, TAB_RIR_CLASSIFICACAO.CLASSRIR_CODIGO, TAB_APOIO_TPVISITRIR.DESCRICAO AS PRI_ATIV, TAB_APOIO_TPSUBVISITRIR.DESCRICAO AS SUB_ATIV, TAB_RIR_CLASSIFICACAO.CLASSRIR_DESCRICAO, TAB_415421_EVENTOS.EVENTOS_DATA from TAB_415421_EVENTOS left outer join TAB_RIR_CLASSIFICACAO on TAB_RIR_CLASSIFICACAO.EVENTOS_CODIGO = TAB_415421_EVENTOS.EVENTOS_CODIGO left outer join TAB_APOIO_TPSUBVISITRIR on TAB_RIR_CLASSIFICACAO.CLASSRIR_TIPO = TAB_APOIO_TPSUBVISITRIR.ID left outer join TAB_APOIO_TPVISITRIR on TAB_APOIO_TPVISITRIR.ID = TAB_APOIO_TPSUBVISITRIR.ID_PRINCIPAL where TAB_RIR_CLASSIFICACAO.CLASSRIR_CODIGO is not null and TAB_415421_EVENTOS.FAMILIA_CODIGO = '$id_familia' AND (TAB_RIR_CLASSIFICACAO.CLASSRIR_DESCRICAO IS NOT NULL OR TAB_RIR_CLASSIFICACAO.CLASSRIR_DESCRICAO <> '') order by TAB_415421_EVENTOS.EVENTOS_DATA DESC, TAB_415421_EVENTOS.EVENTOS_CODIGO asc, PRI_ATIV asc, SUB_ATIV asc;", $db);
			$sql_TECNICOS = mysql_query("SELECT DISTINCT tab_apoio_tecnicos.DESCRICAO from TAB_415421_EVENTOS left outer join TAB_415421_TECNICOS ON TAB_415421_TECNICOS.EVENTOS_CODIGO = TAB_415421_EVENTOS.EVENTOS_CODIGO left outer join TAB_APOIO_TECNICOS ON TAB_415421_TECNICOS.TECNICOS_TECNICO = TAB_APOIO_TECNICOS.ID WHERE tab_415421_eventos.FAMILIA_CODIGO = '$id_familia' AND tab_apoio_tecnicos.ID <> 0;", $db);
			$sql_IMAGENS = mysql_query("select TAB_415421_IMAGENS.IMAGEM_CODIGO, TAB_415421_IMAGENS.EVENTOS_CODIGO, TAB_415421_IMAGENS.IMAGEM_NOME, TAB_415421_IMAGENS.IMAGEM_LEGENDA from TAB_415421_IMAGENS where TAB_415421_EVENTOS.FAMILIA_CODIGO = '$id_familia';", $db);
?>
<!DOCTYPE html>
<html>
<head lang="en">
...
<body>
    ...
    <table>
        <tbody>
            <tr><td align="center" valign="middle"><h1>FICHA CADASTRAL DA FAMÍLIA</h1></td></tr>
            <tr><td align="center" valign="middle"><h1>ACOMPANHAMENTO TÉCNICO</h1></td></tr>
	    </tbody>	
    </table><br/>
    <table>
    <tr align="left">
	...
	<table>
		<tr><td colspan="5" bgcolor="#D9D9D9"><strong>1. INFORMAÇÕES E RECOMENDAÇÕES TÉCNICAS - PROJETO 4.1.5</strong></td></tr>
        <tr><td colspan="5">&nbsp;</td></tr>
		<?php while ($vetor_VISITAS415 = mysql_fetch_array($sql_VISITAS415)) { ?>
        	<tr><td colspan="5" bgcolor="#E7E7E7"><strong><?php echo $vetor_VISITAS415['PRI_ATIV'] ?></strong></td></tr>
            <tr><td colspan="5">&nbsp;</td></tr>
			<tr>
            	<td width="5%"><?php echo date('d/m/Y', strtotime($vetor_VISITAS415['EVENTOS_DATA'])); ?></td>
                <td width="5%">&nbsp;</td>
	...
	<table>
		<tr><td colspan="5" bgcolor="#D9D9D9"><strong>2. INFORMAÇÕES E RECOMENDAÇÕES TÉCNICAS - PROJETO 4.2.1</strong></td></tr>
        <tr><td colspan="5">&nbsp;</td></tr>
		<?php while ($vetor_VISITAS421 = mysql_fetch_array($sql_VISITAS421)) { ?>
        	<tr><td colspan="5" bgcolor="#E7E7E7"><strong><?php echo $vetor_VISITAS421['PRI_ATIV'] ?></strong></td></tr>
            <tr><td colspan="5">&nbsp;</td></tr>
			<tr>
            	<td width="5%"><?php echo date('d/m/Y', strtotime($vetor_VISITAS421['EVENTOS_DATA'])); ?></td>
                <td width="5%">&nbsp;</td>
	...
	<table>
		<tr><td colspan="5" bgcolor="#D9D9D9"><strong>3. INFORMAÇÕES E RECOMENDAÇÕES TÉCNICAS - RIBEIRINHOS</strong></td></tr>
        <tr><td colspan="5">&nbsp;</td></tr>
		<?php while ($vetor_VISITASRIR = mysql_fetch_array($sql_VISITASRIR)) { ?>
        	<tr><td colspan="3" bgcolor="#E7E7E7"><strong><?php echo $vetor_VISITASRIR['PRI_ATIV'] ?></strong></td></tr>
            <tr><td colspan="5">&nbsp;</td></tr>
			<tr>
            	<td width="5%"><?php echo date('d/m/Y', strtotime($vetor_VISITASRIR['EVENTOS_DATA'])); ?></td>
                <td width="5%">&nbsp;</td>
	...
	<table>
		<tr><td colspan="2" bgcolor="#D9D9D9"><strong>4. TÉCNICOS QUE JÁ REALIZARAM ATENDIMENTOS À FAMÍLIA</strong></td></tr>
