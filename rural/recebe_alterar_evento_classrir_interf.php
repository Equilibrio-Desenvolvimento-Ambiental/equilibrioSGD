<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$CLASSRIRINT_TIPO = $_POST['subtiporir_interf'];
			$CLASSRIRINT_DESCRICAO = $_POST['CLASSRIRINT_DESCRICAO'];
			$sql = mysql_query("UPDATE TAB_RIRINT_CLASSIFICACAO SET CLASSRIRINT_TIPO = '$CLASSRIRINT_TIPO', CLASSRIRINT_DESCRICAO = '$CLASSRIRINT_DESCRICAO' WHERE CLASSRIRINT_CODIGO = '$id' AND EVENTOS_CODIGO = '$id_evento';", $db) or die(mysql_error());
