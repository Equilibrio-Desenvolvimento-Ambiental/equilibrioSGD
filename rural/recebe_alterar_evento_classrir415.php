<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$CLASSRIR415_TIPO = $_POST['subtiporir415'];
			$CLASSRIR415_DESCRICAO = $_POST['CLASSRIR415_DESCRICAO'];
			$sql = mysql_query("UPDATE TAB_RIR415_CLASSIFICACAO SET CLASSRIR415_TIPO = '$CLASSRIR415_TIPO', CLASSRIR415_DESCRICAO = '$CLASSRIR415_DESCRICAO' WHERE CLASSRIR415_CODIGO = '$id' AND EVENTOS_CODIGO = '$id_evento';", $db) or die(mysql_error());
