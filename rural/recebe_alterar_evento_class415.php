<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$CLASS415_TIPO = $_POST['subtipo415'];
			$CLASS415_DESCRICAO = $_POST['CLASS415_DESCRICAO'];
			$sql = mysql_query("UPDATE TAB_415_CLASSIFICACAO SET CLASS415_TIPO = '$CLASS415_TIPO', CLASS415_DESCRICAO = '$CLASS415_DESCRICAO' WHERE CLASS415_CODIGO = '$id' AND EVENTOS_CODIGO = '$id_evento';", $db) or die(mysql_error());
