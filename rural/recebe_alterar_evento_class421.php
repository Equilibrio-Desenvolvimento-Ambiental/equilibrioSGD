<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$CLASS421_TIPO = $_POST['subtipo421'];
			$CLASS421_DESCRICAO = $_POST['CLASS421_DESCRICAO'];
			$sql = mysql_query("UPDATE TAB_421_CLASSIFICACAO SET CLASS421_TIPO = '$CLASS421_TIPO', CLASS421_DESCRICAO = '$CLASS421_DESCRICAO' WHERE CLASS421_CODIGO = '$id' AND EVENTOS_CODIGO = '$id_evento';", $db) or die(mysql_error());
