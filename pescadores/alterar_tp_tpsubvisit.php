<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("SELECT * FROM TAB_APOIO_TPSUBVISITFISH WHERE ID = '$id';", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_tpsubvisit.php?id=<?php echo $id; ?>" method="post" name="tp_tpsubvisit" enctype="multipart/form-data" id="formID">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea rows='5' class='form-control' name='TEXTO_PADRAO'><?php echo $vetor['TEXTO_PADRAO']; ?></textarea>
                        </div>
                    </div>
                    </br>
