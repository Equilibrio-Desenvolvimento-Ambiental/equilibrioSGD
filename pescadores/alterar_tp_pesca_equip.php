<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("SELECT * FROM TAB_APOIO_PESCA_EQUIP WHERE ID = '$id';", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Tipos de Equipamentos de Pesca (Tralha) - v.1.0.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_pesca_equip.php?id=<?php echo $id; ?>" method="post" name="tp_pesca_equip" enctype="multipart/form-data" id="formID">
