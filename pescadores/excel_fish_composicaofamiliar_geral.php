<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$tabela .= '<th align="center"><b>Código - Componente</b></th>';
			...
			header("Content-Disposition: attachment; filename=excel_fish_composicaofamiliar_geral.xls");
