<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$tabela .= '</thead>';
			$tabela .= '<tbody>';
			$sql = mysql_query("SELECT * FROM TAB_APOIO_FREQCONSUMPROT ORDER BY ID ASC;", $db) or die(mysql_error()); 
			...
			header("Content-Disposition: attachment; filename=excel_tp_freqconsumprot.xls");
