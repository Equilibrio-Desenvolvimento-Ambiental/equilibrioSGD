	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">							
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Tipos de Dificuldades para Execução da Atividade Econômica - v.1.0.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_dificuldadesproducao.php" method="post" name="recebe_cadastrar_tp_dificuldadesproducao" enctype="multipart/form-data" id="recebe_cadastrar_tp_dificuldadesproducao">
