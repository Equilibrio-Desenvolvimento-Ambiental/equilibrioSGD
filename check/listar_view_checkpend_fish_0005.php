	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			if($filter == 0){
				...
				$sql = mysql_query("SELECT * FROM VIEW_CHECKPEND_FISH_0005 ORDER BY VIEW_CHECKPEND_FISH_0005.FISH_FAM_QUEST ASC LIMIT $startAt, $byPage;", $db) or die(mysql_error());
			}
			if($filter == 1) {
				if(isset($_POST["filter"])):
				...
				$totalPages = ceil($totalRecords/$byPage); 
				$totalPages = ceil($totalRecords/$byPage); 
				$sql = mysql_query("SELECT * FROM VIEW_CHECKPEND_FISH_0005 WHERE VIEW_CHECKPEND_FISH_0005.FISH_FAM_CHEFE_NOME LIKE '%".$FISH_FAM_CHEFE_NOME."%' ORDER BY VIEW_CHECKPEND_FISH_0005.FISH_FAM_QUEST ASC LIMIT $startAt, $byPage;", $db) or die(mysql_error());
			}
?>
		...
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">View 0005 - Verificação das Famílias que tiveram a tralha entregue e não possuem o recibo assinado, digitalizado e anexado</a></li>
							</ol>
						</div>
					</div>
				</div>
			</header>
			<form action="listar_view_checkpend_fish_0005.php" method="post" name="listar_view_checkpend_fish_0005" onSubmit="return validaForm()" id="listar_view_checkpend_fish_0005">
            ...
            <table id="table-sm" class="table table-bordered table-hover table-sm">
                <thead>
                    <tr>
                        ...
                        <th width="30px" valign="center"><a class="fancybox fancybox.ajax" href="excel_view_checkpend_fish_0005.php"><img src="imgs/excel.png" width="25" height="25" border="0"></a></th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div id="navigation" class="div_arrows">
                <?php
                    if($page>1):
                        $pagePrevious = $page-1;
                        echo '<a href="listar_view_checkpend_fish_0005.php?page=1&filter='.$filter.'"><img src="imgs/arrow_first.png" width="25" height="25" alt="Primeira Página"></a>';
                        echo '<a href="listar_view_checkpend_fish_0005.php?page='.$pagePrevious.'&filter='.$filter.'"><img src="imgs/arrow_previos.png" width="25" height="25" alt="Página Anterior"></a>';
                    else:
                    ...
                    if($page<$totalPages):
                        $pageNext = $page+1;
                        echo '<a href="listar_view_checkpend_fish_0005.php?page='.$pageNext.'&filter='.$filter.'"><img src="imgs/arrow_next.png" width="25" height="25" alt="Próxima Página"></a>';
                        echo '<a href="listar_view_checkpend_fish_0005.php?page='.$totalPages.'&filter='.$filter.'"><img src="imgs/arrow_last.png" width="25" height="25" alt="Última Página"></a>';
                    else:
