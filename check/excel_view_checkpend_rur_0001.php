<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$tabela .= '<th align="center"><b>Data do Evento</b></th>';
			$tabela .= '<th align="center"><b>Tipo do Evento</b></th>';
			$tabela .= '</tr>';
			$tabela .= '</thead>';
			$tabela .= '<tbody>';
			$sql = mysql_query("SELECT * FROM VIEW_CHECKPEND_RUR_0001 ORDER BY VIEW_CHECKPEND_RUR_0001.FAMILIA_BENEFICIARIO ASC, VIEW_CHECKPEND_RUR_0001.EVENTOS_DATA DESC;", $db) or die(mysql_error()); 
			...
			header("Content-Disposition: attachment; filename=excel_view_checkpend_rur_0001.xls");
