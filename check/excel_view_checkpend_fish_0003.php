<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$tabela .= '</thead>';
			$tabela .= '<tbody>';
			$sql = mysql_query("SELECT * FROM VIEW_CHECKPEND_FISH_0003 ORDER BY VIEW_CHECKPEND_FISH_0003.FISH_FAM_QUEST ASC;", $db) or die(mysql_error()); 
			...
			header("Content-Disposition: attachment; filename=excel_view_checkpend_fish_0003.xls");
