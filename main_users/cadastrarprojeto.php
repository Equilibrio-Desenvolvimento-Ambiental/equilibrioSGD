	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<form action="recebe_cadastrarprojeto.php" method="post" name="projetos" enctype="multipart/form-data" id="formID">

                    <div class="form-group row">
                        <label for="exampleSelect" class="col-sm-2 form-control-label">Nome do Projeto:</label>
                            <div class="col-sm-10">
                                <input type="text" name="nomeProjeto" class="form-control" id="exampleInput" placeholder="Digite o nome do projeto...">
                            </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleSelect" class="col-sm-2 form-control-label">URL do Projeto:</label>
                            <div class="col-sm-10">
                                <input type="text" name="linkpastaProjeto" class="form-control" id="exampleInput" placeholder="Digite a URL do projeto...">
                            </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleSelect" class="col-sm-2 form-control-label">Sequência de Ordenação do Projeto:</label>
                            <div class="col-sm-10">
                                <input type="text" name="ordemProjeto" class="form-control" id="exampleInput" placeholder="Digite a sequência de ordenação do projeto...">
                            </div>
                    </div>
                    </br>
