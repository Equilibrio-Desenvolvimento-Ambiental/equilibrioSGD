		...
		if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
			...
			$num_permissao = mysql_num_rows($sql_permissao);
				if ($num_permissao == 0) {
					...
					$id = $_GET['id'];
					$sql_exclui_permissoes = mysql_query("delete from TAB_MAIN_USERS_PROJECTS where ID_USER = '$id'", $db);
					$sql_exclui = mysql_query("delete from TAB_MAIN_USERS where ID_USER = '$id'", $db);
		/*
