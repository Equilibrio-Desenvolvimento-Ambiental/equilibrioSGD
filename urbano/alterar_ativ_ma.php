<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("select * from TAB_444_ATIV_MA where ATIVMA_CODIGO = '$id'", $db);
			...
			$sql_EVENTO = mysql_query("select * from TAB_APOIO_EVENUC_MA order by DESCRICAO ASC", $db);
			$sql_ATIVIDADE = mysql_query("select * from TAB_APOIO_ATIVNUC_MA order by DESCRICAO ASC", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Atividade do Núcleo de Meio Ambiente</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				<form action="recebe_alterar_ativ_ma.php?id=<?php echo $id; ?>" method="post" name="ativ_ma" enctype="multipart/form-data" id="formID">
                <div class="row">
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label semibold" for="exampleInput">Data:</label>
							<input type="text" name="ATIV_DATA" class="form-control" id="exampleInput" placeholder="Digite a data..." onKeyPress="mascara(this,mdata)" maxlength="10" value="<?php echo date('d/m/Y', strtotime($vetor['ATIVMA_DATA'])); ?>">
						</fieldset>
					</div>
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputEmail1">Nº de Participantes:</label>
							<input type="text" name="ATIV_PARTICIPANTES" class="form-control" id="exampleInput" placeholder="Digite o n° de participantes..." value="<?php echo $vetor['ATIVMA_PARTICIPANTES']; ?>">
						</fieldset>
					</div>
					<div class="col-lg-3">
						<fieldset class="form-group">
							...
							<select name="ATIV_RUC" id="exampleSelect" class="form-control">
                              ...
                              <option label="<?php echo $vetor_RUC['DESCRICAO']; ?>" value="<?php echo $vetor_RUC['ID'] ?>" <?php if (strcasecmp($vetor['ATIVMA_RUC'], $vetor_RUC['ID']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_RUC['DESCRICAO'] ?></option>
                              <?php } ?>
                            </select>
						</fieldset>
					</div>
                    <div class="col-lg-3">
						<fieldset class="form-group">
							...
							<select name="ATIV_PERIODO" id="exampleSelect" class="form-control">
                              ...
                              <option label="<?php echo $vetor_PERIODO['DESCRICAO']; ?>" value="<?php echo $vetor_PERIODO['ID']; ?>" <?php if (strcasecmp($vetor['ATIVMA_PERIODO'], $vetor_PERIODO['ID']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_PERIODO['DESCRICAO']; ?></option>
                              <?php } ?>
                            </select>
						</fieldset>
					</div>
                ...
                <div class="form-group row">
						...
						<div class="col-sm-10">
							<select name="ATIV_EVENTO" id="exampleSelect" class="form-control">
                              ...
                              <option label="<?php echo $vetor_EVENTO['DESCRICAO']; ?>" value="<?php echo $vetor_EVENTO['ID']; ?>" <?php if (strcasecmp($vetor['ATIVMA_EVENTO'], $vetor_EVENTO['ID']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_EVENTO['DESCRICAO']; ?></option>
                              <?php } ?>
                            </select>
						</div>
				</div>
						...
						<div class="col-sm-10">
							<select name="ATIV_ATIVIDADE" id="exampleSelect" class="form-control">
                              <option value="" selected="selected">Selecione o tipo da atividade...</option>
                               ...
                               <option label="<?php echo $vetor_ATIVIDADE['DESCRICAO']; ?>" value="<?php echo $vetor_ATIVIDADE['ID']; ?>" <?php if (strcasecmp($vetor['ATIVMA_ATIVIDADE'], $vetor_ATIVIDADE['ID']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_ATIVIDADE['DESCRICAO']; ?></option>
                              <?php } ?>
	                        </select>
						</div>
				</div>
                <div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea rows="4" name="ATIV_DESCRICAO" class="form-control" placeholder="Descrição da Atividade"><?php echo $vetor['ATIVMA_DESCRICAO']; ?></textarea>
						</div>
				</div>
                <div class="form-group row">
						<label for="exampleSelect" class="col-sm-2 form-control-label">Percepções Descritivas:</label>
						<div class="col-sm-10">
							<textarea rows="4" name="ATIV_PERCEPCAO" class="form-control" placeholder="Percepções"><?php echo $vetor['ATIVMA_PERCEPCOES']; ?></textarea>
						</div>
				</div>
                </br>
                    ...
                    <div class="tabcontents">
                        <div id="view1">
                            ...
                            <table id="table-sm" class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
									<?php 
                                    	$sql_ATIVMA_ENTID = mysql_query("select TAB_444_ATIV_MA_PART.PARTATIVMA_CODIGO, TAB_444_ATIV_MA_PART.ATIVMA_CODIGO, TAB_APOIO_ENTIDINST.DESCRICAO from TAB_444_ATIV_MA_PART left outer join TAB_APOIO_ENTIDINST on TAB_444_ATIV_MA_PART.PARTATIVMA_PARTICIPANTE = TAB_APOIO_ENTIDINST.ID where TAB_444_ATIV_MA_PART.ATIVMA_CODIGO = '$id' order by TAB_APOIO_ENTIDINST.DESCRICAO asc;", $db);
                                    	while ($vetor_ATIVMA_ENTID = mysql_fetch_array($sql_ATIVMA_ENTID)) {
                                    ?>
                                    <tr>
                                    	<td><?php echo $vetor_ATIVMA_ENTID['DESCRICAO']; ?></td>
                                        <td><a class="fancybox fancybox.ajax" href="recebe_excluir_ativ_ma_entid.php?id=<?php echo $vetor_ATIVMA_ENTID['PARTATIVMA_CODIGO']; ?>&id_ativ=<?php echo $id; ?>"><img src="imgs/excluir.png" width="25" height="25" border="0"></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                        	</table>
                        ...
                        <div id="view2">
                            ...
                            <table id="table-sm" class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
									<?php 
                                    	$sql_ATIVMA_TEC = mysql_query("select TAB_444_ATIV_MA_TEC.TECATIVMA_CODIGO, TAB_444_ATIV_MA_TEC.ATIVMA_CODIGO, TAB_APOIO_TECNICOS.DESCRICAO from TAB_444_ATIV_MA_TEC left outer join TAB_APOIO_TECNICOS on TAB_444_ATIV_MA_TEC.TECATIVMA_TECNICO = TAB_APOIO_TECNICOS.ID where TAB_444_ATIV_MA_TEC.ATIVMA_CODIGO = '$id' order by TAB_APOIO_TECNICOS.DESCRICAO asc;", $db);
                                    	while ($vetor_ATIVMA_TEC = mysql_fetch_array($sql_ATIVMA_TEC)) {
                                    ?>
                                    <tr>
                                    	<td><?php echo $vetor_ATIVMA_TEC['DESCRICAO']; ?></td>
                                        <td><a class="fancybox fancybox.ajax" href="recebe_excluir_ativ_ma_tec.php?id=<?php echo $vetor_ATIVMA_TEC['TECATIVMA_CODIGO']; ?>&id_ativ=<?php echo $id; ?>"><img src="imgs/excluir.png" width="25" height="25" border="0"></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
							</table>
                        ...
                        <div id="view3">
                            ...
                            <table id="table-sm" class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
									<?php 
                                    	$sql_ATIVMA_IMG = mysql_query("select * from TAB_444_ATIV_MA_IMAGENS where ATIVMA_CODIGO = '$id';", $db);
                                    	while ($vetor_ATIVMA_IMG = mysql_fetch_array($sql_ATIVMA_IMG)) {
                                    ?>
                                    <tr>
                                    	<td><?php echo $vetor_ATIVMA_IMG['IMGATIVMA_LEGENDA']; ?></td>
                                    	<td><img src="imagens/<?php echo $vetor_ATIVMA_IMG['IMGATIVMA_NOME']; ?>" width="150"></td>
                                        <td><a class="fancybox fancybox.ajax" href="recebe_excluir_ativ_ma_img.php?id=<?php echo $vetor_ATIVMA_IMG['IMGATIVMA_CODIGO']; ?>&id_ativ=<?php echo $id; ?>"><img src="imgs/excluir.png" width="25" height="25" border="0"></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
							</table>
                        ...
                        <div id="view4">
                            ...
                            <table id="table-sm" class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
									<?php 
                                    	$sql_ATIVMA_PERC = mysql_query("select TAB_444_ATIV_MA_PERCEP.PERCEPATIVMA_CODIGO, TAB_444_ATIV_MA_PERCEP.ATIVMA_CODIGO, TAB_APOIO_PERCEPCOES.DESCRICAO from TAB_444_ATIV_MA_PERCEP left outer join TAB_APOIO_PERCEPCOES on TAB_444_ATIV_MA_PERCEP.PERCEPATIVMA_PERCEP = TAB_APOIO_PERCEPCOES.ID where TAB_444_ATIV_MA_PERCEP.ATIVMA_CODIGO = '$id' order by TAB_APOIO_PERCEPCOES.DESCRICAO asc;", $db);
                                    	while ($vetor_ATIVMA_PERC = mysql_fetch_array($sql_ATIVMA_PERC)) {
                                    ?>
                                    <tr>
                                    	<td><?php echo $vetor_ATIVMA_PERC['DESCRICAO']; ?></td>
                                        <td><a class="fancybox fancybox.ajax" href="recebe_excluir_ativ_ma_perc.php?id=<?php echo $vetor_ATIVMA_PERC['PERCEPATIVMA_CODIGO']; ?>&id_ativ=<?php echo $id; ?>"><img src="imgs/excluir.png" width="25" height="25" border="0"></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
							</table>
