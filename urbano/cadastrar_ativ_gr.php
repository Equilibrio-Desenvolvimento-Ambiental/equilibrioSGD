	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Atividade do Núcleo de Geração de Renda</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				<form action="recebe_cadastrar_ativ_gr.php" method="post" name="ativ_gr" enctype="multipart/form-data" id="formID">
                <div class="row">
					<div class="col-lg-3">
