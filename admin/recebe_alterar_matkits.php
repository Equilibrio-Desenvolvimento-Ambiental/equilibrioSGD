<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("update TAB_ADM_MATKITS set MATKIT_NOME = '$MATKIT_NOME' where MATKIT_ID = '$id';", $db) or die(mysql_error());
			...
			foreach((array)$vetor_MATCONSUMOS as $vetor_MATCONSUMOSkey){
				...
				$sql_MATKITC = mysql_query("insert into TAB_ADM_MATKITS_CON (MATKITC_KIT, MATKITC_ITEM, MATKITC_QTDE) values ('$id', '$ITEM', '$QTDE')", $db);
				$cont_MATCONSUMOS++;
				}
			}
/*			
			...
			foreach((array)$vetor_MATUSO as $vetor_MATUSOkey){
				...
				$sql_MATKITU = mysql_query("insert into TAB_ADM_MATKITS_USO (MATKITU_KIT, MATKITU_ITEM, MATKITU_QTDE) values ('$id', '$ITEM', '$QTDE')", $db);
				$cont_MATUSO++;
				}
			}
*/
