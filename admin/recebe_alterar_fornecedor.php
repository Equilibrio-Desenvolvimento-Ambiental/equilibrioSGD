<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("UPDATE TAB_ADM_FORNECEDOR SET FORNEC_NOME = '$FORNEC_NOME', FORNEC_NOMEFANT =  '$FORNEC_NOMEFANT', FORNEC_CPFCNPJ = '$FORNEC_CPFCNPJ', FORNEC_NOMERESP = '$FORNEC_NOMERESP', FORNEC_INSCEST = '$FORNEC_INSCEST', FORNEC_INSCMUN = '$FORNEC_INSCMUN', FORNEC_ENDERECO = '$FORNEC_ENDERECO', FORNEC_NUMERO = '$FORNEC_NUMERO', FORNEC_COMPL = '$FORNEC_COMPL', FORNEC_BAIRRO = '$FORNEC_BAIRRO', FORNEC_MUNICIPIO = '$FORNEC_MUNICIPIO', FORNEC_CEP = '$FORNEC_CEP', FORNEC_FONE01 = '$FORNEC_FONE01', FORNEC_FONE02 = '$FORNEC_FONE02', FORNEC_EMAIL = '$FORNEC_EMAIL', FORNEC_ANOTACOES = '$FORNEC_ANOTACOES' WHERE FORNEC_ID = '$id';", $db) or die(mysql_error());
		/*
