	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Entrada de Ferramentas // Outros Produtos</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				<form action="recebe_cadastrar_entradaprod_uso.php" method="post" name="entradaprod_uso" enctype="multipart/form-data" id="formID">
                    <div class="form-group row">
                        <div class="col-lg-4">
                        	<label class="form-label semibold" for="exampleInput">Data:</label>
                            <input type="text" name="PRODENTU_DATA" class="form-control" id="exampleInput" placeholder="Digite a data..." onKeyPress="mascara(this,mdata)">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <select name="PRODENTU_PRODUTO" id="exampleSelect" class="form-control">
                                ...
                                <option value="<?php echo $vetor_MATUSO['MATUSO_ID']; ?>"><?php echo $vetor_MATUSO['MATUSO_NOME'].' ('.$vetor_MATUSO['MATUSO_UNIDADE_DESC'].')'; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="PRODENTU_VALOR" class="form-control" id="exampleInput" placeholder="Digite o valor..." onKeyPress="mascara(this,mvalor)" value="0,00">
                        </div>
                        <div class="col-lg-3">
                        	<label class="form-label semibold" for="exampleInput">Quantidade:</label>
                            <input type="text" name="PRODENTU_QTDE" class="form-control" id="exampleInput" placeholder="Digite a qtde..." value="1" >
                        </div>
                    </div>
                    </br>
