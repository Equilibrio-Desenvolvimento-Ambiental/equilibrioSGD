	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Tipos de Atividades do Projeto Ribeirinho - v 1.1.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_tpvisitrir.php" method="post" name="recebe_cadastrar_tp_tpvisitrir" enctype="multipart/form-data" id="recebe_cadastrar_tp_tpvisitrir">
