<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql = mysql_query("UPDATE TAB_APOIO_TPSUBVISITRIR415 SET DESCRICAO = '$DESCRICAO', ATIVO = '$ATIVO', ID_PRINCIPAL = '$ID_PRINCIPAL' WHERE ID = '$id';", $db) or die(mysql_error());
		/*
		...
		*/				
			echo"<script language=\"JavaScript\">
				location.href=\"listar_tp_tpsubvisitrir415.php\";
				</script>";
		}
	}
?>
