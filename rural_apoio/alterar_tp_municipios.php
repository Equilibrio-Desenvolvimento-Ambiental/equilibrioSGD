<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("select * from TAB_APOIO_MUNICIPIOS where ID = '$id'", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Municípios</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_municipios.php?id=<?php echo $id; ?>" method="post" name="tp_municipios" enctype="multipart/form-data" id="formID">
					...
					<div class="form-group row">
                    	...
                    	<div class="col-sm-10">
							<select name="UF" id="exampleSelect" class="form-control">
                              ...
                              <option label="<?php echo $vetor_UF['DESCRICAO']." (".$vetor_UF['SIGLA'].")"; ?>" value="<?php echo $vetor_UF['ID']; ?>" <?php if (strcasecmp($vetor['UF'], $vetor_UF['ID']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_UF['DESCRICAO']." (".$vetor_UF['SIGLA'].")"; ?></option>
                              <?php } ?>
                           </select>
						</div>                           
					</div>
