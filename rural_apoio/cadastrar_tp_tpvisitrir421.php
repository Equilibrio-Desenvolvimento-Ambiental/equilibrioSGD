	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Tipos de Atividades do Projeto Ribeirinho (ATES) - v 1.1.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_tpvisitrir421.php" method="post" name="recebe_cadastrar_tp_tpvisitrir421" enctype="multipart/form-data" id="recebe_cadastrar_tp_tpvisitrir421">
