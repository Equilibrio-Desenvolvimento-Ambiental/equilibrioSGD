<?php
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$sql_PRINCIPAL = mysql_query("SELECT * FROM TAB_APOIO_TPVISITRIR421 WHERE ATIVO = '1' ORDER BY DESCRICAO ASC;", $db) or die(mysql_error());
			$id = $_GET['id'];
			$sql = mysql_query("SELECT * FROM TAB_APOIO_TPSUBVISITRIR421 WHERE ID = '$id';", $db) or die(mysql_error());
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Tipos de SubAtividades do Projeto Ribeirinho (ATES) - v 1.1.0.0</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_tpsubvisitrir421.php?id=<?php echo $id; ?>" method="post" name="recebe_alterar_tp_tpsubvisitrir421" enctype="multipart/form-data" id="recebe_alterar_tp_tpsubvisitrir421">
