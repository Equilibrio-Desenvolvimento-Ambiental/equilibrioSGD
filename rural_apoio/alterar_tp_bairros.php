<?php 
	...
	if(!isset($_SESSION['user']) || !isset($_SESSION['login']) || !isset($_SESSION['senha']) || !isset($_SESSION['nome']) || !isset($_SESSION['nivel'])) {
		...
		if ($num_busca == 0) {
			...
			$id = $_GET['id'];
			$sql = mysql_query("SELECT * FROM TAB_APOIO_BAIRROS WHERE ID = '$id';", $db);
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Alteração de Bairros</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_alterar_tp_bairros.php?id=<?php echo $id; ?>" method="post" name="tp_bairros" enctype="multipart/form-data" id="formID">
                    <div class="form-group row">
	                    <label for="exampleSelect" class="col-sm-2 form-control-label">Nome do Bairro:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" name="DESCRICAO" class="form-control" id="DESCRICAO" value="<?php echo $vetor['DESCRICAO']; ?>" placeholder="Digite o nome do bairro...">
                    	</div>
					</div>
					<div class="form-group row">
