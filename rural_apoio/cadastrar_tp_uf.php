	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li><a href="#">Cadastro de Unidades da Federação (UF)</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
                <form action="recebe_cadastrar_tp_uf.php" method="post" name="tp_uf" enctype="multipart/form-data" id="formID">
                    ...
                    <div class="form-group row">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" name="SIGLA" class="form-control" id="exampleInput" placeholder="Digite a sigla...">
                    	</div>
					</div>
                    </br>
